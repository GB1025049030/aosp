...
status_t BasicCaptureSession::ConfigureStreams(
  ...
  ALOGE("FreemeEmulated(%s): ConfigureStreams", __FUNCTION__);
...
status_t BasicCaptureSession::BuildPipelines(
  ...
  ALOGE("FreemeEmulated(%s): BuildPipelines", __FUNCTION__);
...
status_t BasicCaptureSession::ConnectProcessChain(
  ...
  ALOGE("FreemeEmulated(%s): ConnectProcessChain", __FUNCTION__);
...
status_t BasicCaptureSession::ProcessRequest(const CaptureRequest& request) {
  ATRACE_CALL();
  ALOGE("FreemeEmulated(%s): BasicCaptureSession::ProcessRequest", __FUNCTION__);
