  ...
  camera_provider_callback_ = {
      .camera_device_status_change = google_camera_hal::CameraDeviceStatusChangeFunc(
          [this](std::string camera_id,
            ...
            ALOGE("FreemeEmulated(%s): Call HidlCameraProvider::Initialize->camera_device_status_change", __FUNCTION__);
            ...
            ALOGE("FreemeEmulated(%s): Call HidlCameraProvider::Initialize->cameraDeviceStatusChange", __FUNCTION__);
      ...
      .physical_camera_device_status_change = google_camera_hal::
          PhysicalCameraDeviceStatusChangeFunc([this](
            ...
            ALOGE("FreemeEmulated(%s): Call HidlCameraProvider::Initialize->physical_camera_device_status_change", __FUNCTION__);
            auto castResult =
            ...
            std::unique_lock<std::mutex> lock(callbacks_lock_);
            ALOGE("FreemeEmulated(%s): Call HidlCameraProvider::Initialize->physicalCameraDeviceStatusChange", __FUNCTION__);
      ...
      .torch_mode_status_change = google_camera_hal::TorchModeStatusChangeFunc(
          [this](std::string camera_id,
            ...
            ALOGE("FreemeEmulated(%s): Call HidlCameraProvider::Initialize->torch_mode_status_change", __FUNCTION__);
            ...
            std::unique_lock<std::mutex> lock(callbacks_lock_);
            ALOGE("FreemeEmulated(%s): Call HidlCameraProvider::Initialize->torchModeStatusChange", __FUNCTION__);
...
Return<void> HidlCameraProvider::getCameraDeviceInterface_V3_x(
  ...
  ALOGE("FreemeEmulated(%s): Call HidlCameraDevice::Create", __FUNCTION__);
