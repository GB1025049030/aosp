...
EmulatedCameraDeviceSessionHwlImpl::Create(
  ...
  ALOGE("FreemeEmulated(%s): Call EmulatedCameraDeviceSessionHwlImpl::Initialize", __FUNCTION__);
...
status_t EmulatedCameraDeviceSessionHwlImpl::Initialize(
  ...
  ALOGE("FreemeEmulated(%s): Call EmulatedCameraDeviceSessionHwlImpl::InitializeRequestProcessor", __FUNCTION__);
...
status_t EmulatedCameraDeviceSessionHwlImpl::InitializeRequestProcessor() {
  ...
  ALOGE("FreemeEmulated(%s): Call EmulatedRequestProcessor::Initialize", __FUNCTION__);
