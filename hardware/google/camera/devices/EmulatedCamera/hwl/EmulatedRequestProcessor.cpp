...
EmulatedRequestProcessor::EmulatedRequestProcessor(
  ...
  request_thread_ = std::thread([this] {
    ALOGE("FreemeEmulated(%s): Call EmulatedRequestProcessor::RequestProcessorLoop", __FUNCTION__);
    this->RequestProcessorLoop();
  });
...
status_t EmulatedRequestProcessor::ProcessPipelineRequests(
  ...
  for (auto& request : requests) {
    ...
    ALOGE("FreemeEmulated(%s)[output_buffers]: Call EmulatedRequestProcessor::CreateSensorBuffers", __FUNCTION__);
    ...
    ALOGE("FreemeEmulated(%s)[input_buffers]: Call EmulatedRequestProcessor::CreateSensorBuffers", __FUNCTION__);
        ...
        if (!output_buffers->empty()) {
          ...
          if (ret == OK) {
            auto result = request_state_->InitializeLogicalResult(pipeline_id,
                                                                  frame_number);
            ALOGE("FreemeEmulated(%s): Call EmulatedSensor::SetCurrentRequest", __FUNCTION__);
...
status_t EmulatedRequestProcessor::Initialize(
  ...
  std::lock_guard<std::mutex> lock(process_mutex_);
  ALOGE("FreemeEmulated(%s): Call EmulatedLogicalRequestState::Initialize", __FUNCTION__);
